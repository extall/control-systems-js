...
csg.timeseries = function (t, u, sel, params = undefined, existing = undefined) {
    ...
    var linecolor = "blue";
    if (params !== undefined && params.linecolor !== undefined) linecolor = params.linecolor;
    ...
    var range_x = csg.autorange_x(tv);
    var range_y = csg.autorange_y(uv);
...
csg.draw_timeseries = function (t, sel, params = undefined, background = undefined) {
    ...
    // TODO: DEBUG > append another plot over it. NB! Not fully operational yet!
    drawable_plot = csg.timeseries([0, 1], [0, 1], sel, {linecolor: 'red'}, drawable_plot);
