...
csg.draw_timeseries = function (t, sel, params = undefined, background = undefined) {
    ...
    // Set: sets background data with index. No check on data is performed
    drawable_plot.userdata.set_background_data = function(index, data){
        if (this.handle.options.data[index] !== undefined){
            this.handle.options.data[index] = data;
        }
    };
